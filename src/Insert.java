...
public class Insert extends JFrame {
	...
	public Insert(resultsettablemodel tablemodel) {
		...
		complete.addActionListener(        
	            new ActionListener() 
	            {
	               public void actionPerformed(ActionEvent event)
	               {
	                  ...
	                  try 
	                  {
	                	 String insertquery = "INSERT INTO people (name,type,phone) VALUE ('"+nametext.getText()+"','"+type+"','"+phonetext.getText()+"');";	                	  
	                     tablemodel.setupdateQuery(insertquery);
